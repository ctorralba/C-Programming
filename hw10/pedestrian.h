...
const float NOTDRUNK = .10;   //determines pedestrian's drunk state
const short PEDSTART = 1;     //used to determine where pedestrian starts
const short FIXORDAMAGE = 1;  //used for calc pedestrian damage or repair.
const short MOVERATE = 4;     //used to calculate drunk movement
const short BACKWARDMOVE = 0; //used to check if drunk move backwards
